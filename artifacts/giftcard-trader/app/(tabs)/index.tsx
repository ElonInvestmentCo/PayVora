      ...
      >
        ...
        <View style={styles.quickActions}>
          {[
            ...
            { label: "History", icon: "clock", color: "#8B5CF6", onPress: () => {} },
            { label: "Rates", icon: "bar-chart-2", color: "#14B8A6", onPress: () => router.push("/(tabs)/rates") },
            { label: "Support", icon: "headphones", color: "#F59E0B", onPress: () => {} },
          ].map((action) => (
            <TouchableOpacity
              key={action.label}
              activeOpacity={0.8}
